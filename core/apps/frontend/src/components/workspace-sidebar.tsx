  ...
  const navigationItems = [
    {
      ...
      current: pathname === `/workspace/${workspaceSlug}/dashboard` || pathname?.startsWith(`/workspace/${workspaceSlug}/dashboard`)
    },
    {
      name: 'Settings',
      href: `/workspace/${workspaceSlug}/settings`,
      icon: Settings,
      current: pathname === `/workspace/${workspaceSlug}/settings` || pathname?.startsWith(`/workspace/${workspaceSlug}/settings`)
    }
  ]
